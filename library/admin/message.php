...
<body style="width: 1550px; height: 600px;">
...
echo "<tr>";
echo "<td width=65>";
echo "<img class='img-circle profile_img' height=60 width=60 src='images/".$res1['pic']."'>";
echo "</td>";
        ...
        <?php
             if(isset($_POST['submit']))
             {
                ...
                ?>
                   ...
                   <h1 style="margin-top: -5px; padding-top:10px;"> <?php echo $_POST['username']; ?> </h1>
                   </div>
                   <div class="msg">
            <?php
